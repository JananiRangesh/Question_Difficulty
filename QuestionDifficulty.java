...
public class QuestionDifficulty { 
  ...
  public static void main(String[] args) {  
    try {
      File myObj = new File("inputData2.txt");
      ...
      while (myReader.hasNextLine()) {
        ...
        System.out.println("Question tpye ==> "+question_type);
       
        String manual_difficulty=input[1];

        System.out.println("Manually set difficulty ==> "+manual_difficulty);
        ...
        for(int i=0;i<total_students;i++){
          if(question_type.equals("MCQ") || question_type.equals("Match") || question_type.equals("Fillups")){
            for(int j=0;j<3;j++){
              if(j==0){
